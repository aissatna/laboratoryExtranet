...
INSERT INTO `anticorps` (`IdentifiantA`, `DesignationA`, `SeuilAlerte`, `EtatStockA`, `VolumePreconise`)
VALUES (1, 'Mouse_AntiHuman', 13, 'Risque', 5),
...
INSERT INTO `cloneanticorps` (`IdentifiantA`, `IdentifiantC`)
VALUES (2, 3),
       (3, 2),
       (3, 3),
       (4, 3),
...
INSERT INTO `clones` (`IdentifiantC`, `LibelleC`)
VALUES (1, '2DF'),
       (2, '5T45'),
       (3, '4RD'),
       (4, '2RT');
...
INSERT INTO `contenir` (`ReferenceT`, `Volume`, `IdentifiantA`)
VALUES (1, 34, 1),
       (1, 10, 2),
       (1, 0, 4),
       (35, 95, 4),
...
INSERT INTO `equipes` (`IdentifiantE`, `NomE`, `ThematiqueE`)
VALUES (1, 'Plasticité des tissus adipieux ', ''),
...
INSERT INTO `especeanticorps` (`IdentifiantA`, `IdentifiantEsp`)
VALUES (1, 4),
       (2, 1),
       (3, 1),
       (4, 3),
...
INSERT INTO `especes` (`IdentifiantEsp`, `LibelleEsp`)
VALUES (1, 'mouse'),
       (2, 'rat'),
       (3, 'hamster'),
       (4, 'goat');
...
INSERT INTO `fluorochromeanticorps` (`IdentifiantA`, `IdentifiantFluo`)
VALUES (1, 19),
       (1, 26),
       (2, 4),
       (2, 7),
...
INSERT INTO `fluorochromes` (`IdentifiantFluo`, `LibelleFluo`)
VALUES (1, 'FITC'),
       (2, 'efluor 605'),
       (3, 'PerCP fluor 710'),
       (4, 'efluor 660'),
...
INSERT INTO `fournir` (`ReferenceT`, `IdentifiantA`, `IdentifiantF`, `QuantiteLiv`)
VALUES (1, 3, 6, 76),
       (36, 4, 4, 100),
       (37, 3, 6, 44);
...
INSERT INTO `fournisseurs` (`IdentifiantF`, `NomF`, `PrenomF`, `EmailF`, `TelephoneF`, `SiteWebF`, `ListeDesPrix`)
VALUES (2, 'dufour', 'laurent', 'laurentdufour@gmail.com', '0667897654', 'http://dedalus.fr', ''),
...
INSERT INTO `gestionnaire` (`IdentifiantG`, `Nom`, `Login`, `MotDePasse`)
VALUES (1, 'Marie', 'admin', 'admin123');
...
INSERT INTO `lots` (`IdentifiantL`, `DatePeremption`)
VALUES (1, '2020-05-30'),
       (2, '2020-06-10'),
       (3, '2020-06-19'),
       (4, '2020-06-27'),
...
INSERT INTO `projets` (`IdentifiantP`, `NomP`, `EmailR`, `DateDebutP`, `DateFinP`)
VALUES (1, 'technologie génitics', 'pierre.marron6@gmail.com', '2020-05-07', '2020-06-25'),
...
INSERT INTO `signaler` (`DateSignalement`, `IdentifiantA`, `IdentifiantP`, `Commentaire`, `TypeSignalement`)
VALUES ('2020-05-30', 1, 1, 'l\'anticorps 1 est en rupture', 'Manque de Stock');
...
INSERT INTO `travailler` (`IdentifiantE`, `IdentifiantP`)
VALUES (1, 2),
       (1, 19),
       (2, 1);
...
INSERT INTO `tubes` (`ReferenceT`, `IdentifiantL`, `TailleT`, `EtatTube`)
VALUES (1, 1, 15, 'vide'),
       (35, 2, 33, 'ouvert'),
       (36, 3, 50, 'ferme'),
       (37, 5, 112, 'ferme'),
...
INSERT INTO `typeanticorps` (`IdentifiantA`, `IdentifiantType`)
VALUES (1, 5),
       (4, 1),
       (4, 5),
       (5, 9);
...
INSERT INTO `types` (`IdentifiantType`, `LibelleType`)
VALUES (1, 'IgG'),
       (2, 'IgG1k'),
       (3, 'igG2'),
       (5, 'IgG2a k'),
...
INSERT INTO `utiliser` (`IdentifiantP`, `IdentifiantA`, `DatePrelevement`)
VALUES (1, 1, '0000-00-00'),
       (2, 2, '0000-00-00');
...
--
ALTER TABLE `anticorps`
    MODIFY `IdentifiantA` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 7;
...
--
ALTER TABLE `clones`
    MODIFY `IdentifiantC` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 8;
...
--
ALTER TABLE `equipes`
    MODIFY `IdentifiantE` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 4;
...
--
ALTER TABLE `especes`
    MODIFY `IdentifiantEsp` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 13;
...
--
ALTER TABLE `fluorochromes`
    MODIFY `IdentifiantFluo` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 34;
...
--
ALTER TABLE `fournisseurs`
    MODIFY `IdentifiantF` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 19;
...
--
ALTER TABLE `gestionnaire`
    MODIFY `IdentifiantG` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 2;
...
--
ALTER TABLE `lots`
    MODIFY `IdentifiantL` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 6;
...
--
ALTER TABLE `tubes`
    MODIFY `ReferenceT` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 39;
...
--
ALTER TABLE `types`
    MODIFY `IdentifiantType` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 14;
