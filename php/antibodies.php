            ...
            <div class="panel-body">
                <table class="table table-bordered table-hover" id="JS-data-table-antibodies">
                    ...
                    <tr>
                        ...
                        <th class="text-center">Fluorochrome</th>
                    ...
                    <?php foreach ($all_antibodies as $antibody): ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <?php echo first_character($antibody['libellefluo']) ?>
                            </td>
                            <td class="text-center">
                                <?php echo first_character($antibody['libelletype']) ?>
                            </td>
                            <td class="text-center">
                                <?php echo first_character($antibody['LibelleC']) ?>
                            </td>
                            <td class="text-center">
                                <?php echo first_character($antibody['LibelleEsp']) ?>
                            </td>
                            <td class="text-center">
